    ...
    <div className="min-h-screen bg-[#0e0e1a] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <div className="text-xs text-indigo-400 font-bold tracking-widest uppercase">{t('subtitle')}</div>
        </div>
        ...
        <form onSubmit={handleLogin} className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-8 space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wide mb-1.5">{t('email')}</label>
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wide mb-1.5">{t('password')}</label>
            <div className="relative">
